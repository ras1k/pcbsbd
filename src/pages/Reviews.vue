<template>
  <section id="reviews" class="bg-violet-100 py-24 relative overflow-hidden">
    <div class="container mx-auto px-4">
      ...
      <div data-aos="zoom-in" class="flex flex-col items-center mb-20">
        ...
        <div class="mt-4 flex items-center gap-3">
          ...
          <span class="text-gray-700 text-lg">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61570132933190"
              target="_blank"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        >
          ...
          <div class="relative z-10">
            ...
            <span
              class="inline-block mt-6 text-sm text-green-600 font-semibold"
            >
      ...
      >
        ...
        <div class="relative z-10">
          ...
          <p class="text-lg mb-8 max-w-2xl mx-auto">
            Join hundreds of happy customers and build your dream PC with PCBSBD
            today.
          </p>
          <router-link
            to="/contact"
...
onMounted(() => {
  const canvases = document.querySelectorAll(
    "#reviews canvas, #reviewsParticles",
  );
