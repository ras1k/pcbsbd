  ...
  <section id="contact" class="py-24 bg-violet-50">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <!-- Contact Form -->
        <div class="bg-white shadow-lg rounded-lg p-8 border border-gray-200" data-aos="slide-right" data-aos-duration="1500">
        ...
        <!-- Contact Info -->
        <div class="bg-white shadow-lg rounded-lg p-8 border border-gray-200" data-aos="slide-left" data-aos-duration="1500">
